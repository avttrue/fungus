...
const QString REPORTS_DIRECTORY =                   "reports";
...
const QString SCENE_BG_COLOR =                      "#B0E0E6";
...
const auto TASKS_WINDOW_HEIGHT =                    350;
const auto TASKS_WINDOW_WIDTH =                     400;
const auto EDITACTIVITY_WINDOW_HEIGHT =             550;
const auto EDITACTIVITY_WINDOW_WIDTH =              350;
const auto EDITCELL_WINDOW_HEIGHT =                 450;
const auto EDITCELL_WINDOW_WIDTH =                  350;
const auto PROJECT_WINDOW_HEIGHT =                  500;
const auto PROJECT_WINDOW_WIDTH =                   350;
const auto REPORT_WINDOW_HEIGHT =                   400;
const auto REPORT_WINDOW_WIDTH =                    350;
const auto SNAPSHOT_WINDOW_HEIGHT =                 250;
const auto SNAPSHOT_WINDOW_WIDTH =                  350;
const auto RANDOMFILL_WINDOW_HEIGHT =               200;
const auto RANDOMFILL_WINDOW_WIDTH =                250;
const auto CELL_INFO_WINDOW_HEIGHT =                250;
const auto CELL_INFO_WINDOW_WIDTH =                 250;
const auto CELL_MONITOR_WINDOW_HEIGHT =             200;
const auto CELL_MONITOR_WINDOW_WIDTH =              650;
const auto FIELD_INFO_WINDOW_HEIGHT =               450;
const auto FIELD_INFO_WINDOW_WIDTH =                300;
const auto EDIT_RULES_WINDOW_HEIGHT =               350;
const auto EDIT_RULES_WINDOW_WIDTH =                800;
const auto RULEPROPERTY_WINDOW_HEIGHT =             350;
const auto RULEPROPERTY_WINDOW_WIDTH =              350;
...
const auto INFORULE_WINDOW_HEIGHT =                 400;
const auto INFORULE_WINDOW_WIDTH =                  800;
...
const uint FIELD_STOP_AT_EVERY_TIME =               0; // 0 - switch off
const bool FIELD_STOP_AT_NEW_MAXDENSITY =           false;
