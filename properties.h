...
const QString SCENE_VIEW_UPDATE_MODE =      "SMART";  // SMART, MINIMAL, FULL
const QString SCENE_FIELD_THREAD_PRIORITY=  "NORMAL"; // LOW, NORMAL, HIGH, HIGHEST
...
const auto SCENE_CALCULATING_MIN_PAUSE =    300;
